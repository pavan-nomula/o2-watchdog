...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico?v=nirvana2", sizes: "any" },
      { rel: "icon", href: "/favicon.svg?v=nirvana2", type: "image/svg+xml" },
      { rel: "icon", href: "/favicon.png?v=nirvana2", type: "image/png" },
      { rel: "apple-touch-icon", href: "/favicon.png?v=nirvana2" },
    ],
  }),
